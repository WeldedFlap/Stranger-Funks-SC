...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'byersHouse':
				houseBG = new BGSprite('stages/byersHouse/ByersHouse', -380, -250, 0.9, 0.9);
				houseBG.frames = Paths.getSparrowAtlas('stages/byersHouse/ByersHouse');
				...
				var trees:BGSprite = new BGSprite('stages/byersHouse/ByersTrees', -380, -250, 1.2, 1.2);
				add(trees);

			case 'field':
				var bg:BGSprite = new BGSprite('stages/field/Bg', -1580, -1150, 1, 1);
				bg.scale.set(1.35, 1.35);
				bg.updateHitbox();
				add(bg);

				overlay1 = new BGSprite('stages/field/overlay1', -2180, -1300, 1, 1);
				overlay1.scale.set(2, 2);
				overlay1.updateHitbox();

				overlay2 = new BGSprite('stages/field/overlay2', -1580, -300, 1, 1);
				overlay2.scale.set(1.5, 1.5);
				overlay2.updateHitbox();

				overlay3 = new BGSprite('stages/field/overlay3', -1380, -650, 1, 1);
				overlay3.scale.set(1.5, 1.5);
				overlay3.updateHitbox();

				overlay4 = new BGSprite('stages/field/overlay4', -1380, -650, 1, 1);
				overlay4.scale.set(1.5, 1.5);
				overlay4.updateHitbox();

				overlay5 = new BGSprite('stages/field/overlay5', -1380, -490, 1, 1);
				overlay5.scale.set(1.5, 1.5);
				overlay5.updateHitbox();

			case 'starCourt':
				var bg:BGSprite = new BGSprite('stages/starCourt/StarCourtBG', -1230, -1200, 1.2, 1.2);
				add(bg);
